// Función del contenedor de imágenes Carousel
$(document).ready(function() {
    $("#featured-products-carousel").owlCarousel({
      ...
      autoplayTimeout: 2000, // Intervalo de tiempo en milisegundos
      responsive: {
        0: {
          items: 1 // Cambiar el número de elementos en pantallas pequeñas
        },
        768: {
          items: 2
        },
    ...
    $("#prevBtn").click(function() {
      $("#featured-products-carousel").trigger("prev.owl.carousel");
    });
  
    $("#nextBtn").click(function() {
      $("#featured-products-carousel").trigger("next.owl.carousel");
    });
  });
  
  // Funciones adicionales para otros sliders y carruseles
  (function($) {
    "use strict";
    ...
    /*---------------------------------------------------
         Product Tab Carousel Slider(Featured,Latest,special,etc..)
    ----------------------------------------------------- */
